 ...
 */
final class Version20201216133802 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE model_primaryColor (model_id INT NOT NULL, model_color_id INT NOT NULL, INDEX IDX_FAF3E4547975B7E7 (model_id), INDEX IDX_FAF3E454B0004E56 (model_color_id), PRIMARY KEY(model_id, model_color_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE model_secondaryColor (model_id INT NOT NULL, model_color_id INT NOT NULL, INDEX IDX_6C74D69B7975B7E7 (model_id), INDEX IDX_6C74D69BB0004E56 (model_color_id), PRIMARY KEY(model_id, model_color_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE model_color (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE model_primaryColor ADD CONSTRAINT FK_FAF3E454B0004E56 FOREIGN KEY (model_color_id) REFERENCES model_color (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE model_secondaryColor ADD CONSTRAINT FK_6C74D69BB0004E56 FOREIGN KEY (model_color_id) REFERENCES model_color (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE model_primaryColor DROP FOREIGN KEY FK_FAF3E454B0004E56');
        $this->addSql('ALTER TABLE model_secondaryColor DROP FOREIGN KEY FK_6C74D69BB0004E56');
        ...
        $this->addSql('DROP TABLE model_color');
